		...
		<div style={{ height: "100%", overflow: "auto", paddingRight: 8 }}>
			...
			>
				<StatCard
					...
					value={<Amount value="820.00" size="display" gradient />}
					caption="3 gifts recorded"
				/>
				<StatCard
					label="Your giving this year"
					value={<Amount value="6,240.00" size="display" />}
				...
				<StatCard
					...
					caption={
						...
						>
							<TypeBadge type="Tithe" /> 3 days ago
						</span>
					}
				/>
			</div>
			...
			>
				...
				<div style={{ flex: 1 }}>
					...
					>
						"Thank you for your faithful giving, Amara. Your contributions this
						month are helping sustain our weekly ministries."
					</div>
				</div>
			</div>
		</div>
				...
				rows={[
					{
						_hover: true,
						date: "Apr 21, 2026",
						type: <TypeBadge type="Tithe" />,
						event: (
							<span style={{ color: S.onSurfaceMuted }}>Sunday Worship</span>
						),
						method: (
							<span
					...
					},
					{
						...
						method: (
							<span
								style={{ display: "inline-flex", gap: 8, alignItems: "center" }}
							>
								<Icon name="cash" size={14} color={S.onSurfaceMuted} />
								Cash
							</span>
						),
						ref: <span style={{ color: S.onSurfaceMuted }}>—</span>,
						amount: <Amount value="120.00" />,
					},
					{
						date: "Mar 31, 2026",
						type: <TypeBadge type="Mission" />,
						event: (
							<span style={{ color: S.onSurfaceMuted }}>Mission Sunday</span>
						),
						method: (
							<span
								style={{ display: "inline-flex", gap: 8, alignItems: "center" }}
					...
					{
						date: "Feb 24, 2026",
						type: <TypeBadge type="First Fruit" />,
						event: <span style={{ color: S.onSurfaceMuted }}>—</span>,
						method: (
							<span
								style={{ display: "inline-flex", gap: 8, alignItems: "center" }}
							>
								<Icon name="check_rect" size={14} color={S.onSurfaceMuted} />
								Check
							</span>
						),
						ref: (
						...
						amount: <Amount value="500.00" />,
					},
					{
						date: "Feb 10, 2026",
						type: <TypeBadge type="Commitment" />,
						event: (
							<span style={{ color: S.onSurfaceMuted }}>Building Fund</span>
						),
						method: (
							<span
								style={{ display: "inline-flex", gap: 8, alignItems: "center" }}
	...
	const events = [
		{
			...
			type: "Service",
			c: "indigo",
			desc: "Weekly gathering for worship, teaching, and communion. Children's ministry available.",
			recurring: true,
			dim: false,
		},
		{
			...
			type: "Special",
			c: "blue",
			desc: "A special Sunday dedicated to supporting our mission partners in Kenya and the Philippines.",
			dim: false,
		},
		{
			day: "12",
			month: "MAY",
			title: "Annual Harvest Thanksgiving",
			loc: "Fellowship Hall · 11:30am",
			type: "Fundraiser",
			c: "amber",
			desc: "Our largest gathering of the year. Join us for worship, a shared meal, and testimonies of God's faithfulness.",
			dim: false,
		},
		{
			day: "19",
			...
			type: "Special",
			c: "blue",
			desc: "A two-day retreat for youth ages 12–18. Permission forms available in the foyer.",
			dim: false,
		},
		{
			day: "26",
		...
		},
		{
			...
			type: "Special",
			c: "blue",
			desc: "If you've started attending Grace recently, we'd love to meet you over a meal.",
			dim: false,
		},
	];
	return (
					...
					{events.map((e, i) => (
						...
						>
							...
							<div style={{ padding: 20, flex: 1 }}>
								...
								>
									<Icon name="location" size={12} color={S.onSurfaceMuted} />
									{e.loc}
								</div>
								<div
									style={{
