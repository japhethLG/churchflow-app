...
const AdminTransactions = () => (
	...
	>
		<div style={{ height: "100%", overflow: "auto" }}>
			...
			>
				<div style={{ width: 260 }}>
					<Input icon="search" placeholder="Search member, note, ref #…" />
				</div>
			...
			>
				...
				>
					...
					>
						{[
							{ c: S.txTithe, l: "Tithe 42%" },
							{ c: S.txOffering, l: "Offering 24%" },
							{ c: S.txMission, l: "Mission 16%" },
						].map((x, i) => (
							<div
								key={i}
				...
				rows={[
					{
						...
						event: (
							<span style={{ color: S.primary, fontSize: 13 }}>
								Sunday Worship
							</span>
						),
						method: (
							...
							>
								<Icon name="bank" size={13} color={S.onSurfaceMuted} />
								Bank
							</span>
						),
						ref: (
					...
					},
					{
						...
						method: (
							...
							>
								<Icon name="cash" size={13} color={S.onSurfaceMuted} />
								Cash
							</span>
						),
						ref: <span style={{ color: S.onSurfaceMuted }}>—</span>,
						amt: <Amount value="100.00" />,
						act: <Icon name="dots" size={16} color={S.onSurfaceMuted} />,
					},
					{
						date: "Apr 20",
						member: (
							<span
								style={{ display: "inline-flex", gap: 8, alignItems: "center" }}
							>
								<Avatar name="Maria Reyes" size={26} />
								Maria Reyes
							</span>
						),
					...
					},
					{
						...
						member: (
							<span
								style={{ display: "inline-flex", gap: 8, alignItems: "center" }}
							>
								<Avatar name="Josh Whitfield" size={26} />
								Josh Whitfield
							</span>
						),
						type: <TypeBadge type="Tithe" />,
						...
						method: (
							...
							>
								<Icon name="check_rect" size={13} color={S.onSurfaceMuted} />
								Check
							</span>
						),
						ref: (
					...
					},
					{
						...
						member: (
							<span
								style={{ display: "inline-flex", gap: 8, alignItems: "center" }}
							>
								<Avatar name="Peter Nguyen" size={26} />
								Peter Nguyen <Badge color="clay">temp</Badge>
							</span>
						),
						type: <TypeBadge type="Offering" />,
						event: (
					...
					},
					{
						...
						member: (
							<span
								style={{ display: "inline-flex", gap: 8, alignItems: "center" }}
							>
								<Avatar name="Rebecca Park" size={26} />
								Rebecca Park
							</span>
						),
		...
		>
			...
			>
				...
				<div>
					...
					>
						<span
							style={{ fontSize: 28, fontWeight: 500, color: S.onSurfaceMuted }}
						>
							$
						</span>
						<span
			...
			>
				<span style={{ fontSize: 11, color: S.onSurfaceMuted }}>
					⌘ Enter to record · Esc to cancel
				</span>
		...
		<div style={{ height: "100%", overflow: "auto" }}>
				...
				{["By Type", "By Member", "By Event", "By Month"].map((t, i) => (
					<div
						...
						style={{
							...
							fontSize: 13,
							fontWeight: 500,
							background: i === 0 ? S.surfaceContainerLowest : "transparent",
			...
			>
				<Card>
					...
					<div
						style={{ display: "grid", placeItems: "center", padding: "20px 0" }}
					>
						<Donut
							size={240}
							total="$98,420"
							data={[
								...
								{ v: 16, color: S.txMission },
								{ v: 10, color: S.txFirstFruit },
								{ v: 5, color: S.txCommitment },
								{ v: 3, color: S.txDonation },
							]}
						/>
					</div>
				</Card>
					...
					<div>
						{[
							...
							<div
								...
								style={{
									display: "grid",
									gridTemplateColumns: "110px 1fr 100px 70px",
									gap: 14,
									alignItems: "center",
									padding: "12px 4px",
								}}
