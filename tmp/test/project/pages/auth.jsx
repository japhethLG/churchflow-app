		...
		>
			...
			<div style={{ justifySelf: "center", width: 440 }}>
				...
				>
					...
					>
						Sign in to your church's dashboard. Your giving history and upcoming
						services will be right where you left them.
					</p>
					...
					>
						...
						<span
							style={{ textDecoration: "underline", color: S.onSurfaceVariant }}
						>
							Terms
						</span>{" "}
						and{" "}
...
const JournalIllustration = () => (
	<svg viewBox="0 0 400 400" width="100%" height="100%" fill="none">
		...
		<path
			d="M260 130 L260 320 L275 305 L290 320 L290 130 Z"
			fill="#7E3000"
			fillOpacity="0.7"
		/>
		{/* Pen */}
		...
		>
			...
			>
				...
				>
					...
					<strong style={{ color: S.onSurface }}>Member</strong>. Sign in with
					Google to accept and see the gifts Grace Community has recorded for
					you.
				</p>
