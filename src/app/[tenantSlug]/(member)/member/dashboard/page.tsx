...
import { MemberKpiStrip } from "@/components/pages/member-dashboard/MemberKpiStrip";
import { MemberRecentGiving } from "@/components/pages/member-dashboard/MemberRecentGiving";
