...
const buttonVariants = cva(
	"group/button inline-flex shrink-0 items-center justify-center rounded-[10px] border-none bg-clip-padding text-sm font-medium whitespace-nowrap transition-all duration-[120ms] ease-out outline-none select-none focus-visible:ring-3 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
	{
		variants: {
			variant: {
				...
				"role-filled": [
					...
					"hover:bg-[var(--btn-700)] hover:shadow-[0_2px_4px_color-mix(in_srgb,var(--btn-800)_20%,transparent)]",
					"active:not-aria-[haspopup]:bg-[var(--btn-800)] active:not-aria-[haspopup]:shadow-none active:not-aria-[haspopup]:translate-y-px",
				...
				"role-gradient": [
					...
					"hover:-translate-y-px hover:[box-shadow:0_10px_24px_-4px_color-mix(in_srgb,var(--btn-grad-b)_50%,transparent)]",
					"active:not-aria-[haspopup]:translate-y-px active:not-aria-[haspopup]:bg-[linear-gradient(135deg,var(--btn-grad-b),var(--btn-grad-b))] active:not-aria-[haspopup]:[box-shadow:0_2px_6px_-2px_color-mix(in_srgb,var(--btn-grad-b)_33%,transparent)]",
				...
				"role-soft": [
					...
					"active:not-aria-[haspopup]:bg-[var(--btn-tonal-bg)] active:not-aria-[haspopup]:text-[var(--btn-tonal-fg)] active:not-aria-[haspopup]:translate-y-px",
					"focus-visible:ring-[var(--btn-200)]",
				...
				"role-tonal": [
					...
					"active:not-aria-[haspopup]:bg-[var(--btn-300)] active:not-aria-[haspopup]:text-[var(--btn-tonal-fg)] active:not-aria-[haspopup]:translate-y-px",
					"focus-visible:ring-[var(--btn-200)]",
					"disabled:!opacity-100 disabled:bg-[#F1F3F6] disabled:text-[#9AA1A9]",
				].join(" "),
				...
				"role-outline": [
					...
					"active:not-aria-[haspopup]:bg-[var(--btn-100)] active:not-aria-[haspopup]:text-[var(--btn-800)] active:not-aria-[haspopup]:shadow-[inset_0_0_0_1px_var(--btn-500)] active:not-aria-[haspopup]:translate-y-px",
				...
				"role-ghost": [
					...
					"active:not-aria-[haspopup]:bg-[var(--btn-100)] active:not-aria-[haspopup]:text-[var(--btn-800)] active:not-aria-[haspopup]:translate-y-px",
					"focus-visible:ring-[var(--btn-200)]",
			...
			size: {
				...
				sm: "h-8 gap-2 px-3.5 text-[13px] [&_svg:not([class*='size-'])]:size-3.5",
