  ...
  return (
    <Card padding={24}>
      ...
      {items.length === 0 ? (
        ...
        >
          <p style={{ margin: 0, marginBottom: 8 }}>This campaign has no line items yet.</p>
          <p style={{ margin: 0, fontSize: 12 }}>
            The campaign goal is the sum of its items&apos; targets — add at least one to start tracking pledges.
          </p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                <div style={{ minWidth: 0 }}>
                  ...
                  >
                    <span>
                      Raised <Amount value={raised.toString()} /> / <Amount value={target.toString()} /> ({raisedPct}%)
                    </span>
                    {pledged > raised && (
                      <span>
                        Pledged <Amount value={pledged.toString()} /> ({pledgedPct}%)
                      </span>
                    )}
                  </div>
                </div>
